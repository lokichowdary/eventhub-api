# Generated by Django 6.0.4 on 2026-04-09 16:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reservations', to='event_app.event')),
            ],
            options={
                'ordering': ['-created_at'],
            },
